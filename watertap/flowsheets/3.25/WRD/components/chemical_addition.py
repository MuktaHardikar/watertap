...
def build_system():
    ...
    build_chem_addition(m, m.fs.chem_addition, "ammonia", m.fs.properties)
...
def build_chem_addition(m, blk, chemical_name, prop_package=None) -> None:
...
if __name__ == "__main__":
    ...
    print("Ammonia added:", m.fs.chem_addition.unit.chemical_flow_vol[0]())
